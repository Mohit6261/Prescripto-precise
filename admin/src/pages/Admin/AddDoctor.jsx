...
const AddDoctor = () => {
  ...
  return (
    <form onSubmit={onSubmitHadler} className='m-5 w-full'>
      <p className='mb-1 text-lg font-medium '>Add Doctor</p>
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
       ...
       <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
        ...
        <div className='w-full lg:flex-1 flex flex-col gap-4'>
          ...
          <div  className='flex-1 flex flex-col gap-1'>
            <p>Address</p>
            <input onChange={(e)=>setAddress1(e.target.value)} value={address1}  className='border rounded px-1 py-2' type="text" placeholder='Address 1' required />
            <input  onChange={(e)=>setAddress2(e.target.value)} value={address2} className='border rounded px-1 py-2' type="text" placeholder='Address 2' required />
          </div>
        </div>
        </div>
        ...
        <div>
          ...
          <button type='submit' className='bg-primary px-10 py-1 mt-4 text-white rounded-full'>Add Doctor</button>
